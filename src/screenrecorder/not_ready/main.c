/**
* The simplest example of FFmpeg based AVDevice (screen recording)
 * Simplest FFmpeg Device (Screen Capture)
 *
* Lei Xiao Hua Lei Xiaohua
 * leixiaohua1020@126.com
* Communication University of China / digital TV technology
 * Communication University of China / Digital TV Technology
 * http://blog.csdn.net/leixiaohua1020
 *
* This program implements a screen recording functionality. You can record and play desktop data. It is based on FFmpeg
* The most simple example libavdevice library. By this example, it is possible to learn the FFmpeg
* Method libavdevice library.
* This program can be used under Windows screen recording in two ways:
GDI-based screen recording equipment under Win32: * 1.gdigrab.
* Desktop crawl time, enter the URL for the "desktop".
* 2.dshow: Use Directshow. Note that you need to install additional software screen-capture-recorder
* You can use x11grab recording screen under Linux.
* In MacOS you can use avfoundation recording screen.
 *
...
int main(int argc, char *argv[])
{
    ...
    // unsigned char *out_buffer=(unsigned char *)av_malloc(avpicture_get_size(AV_PIX_FMT_YUV420P, pCodecCtx->width,
    // pCodecCtx->height)); avpicture_fill((AVPicture *)pFrameYUV, out_buffer, AV_PIX_FMT_YUV420P, pCodecCtx->width,
    // pCodecCtx->height); SDL----------------------------
